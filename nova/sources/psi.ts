...
/**
 * PageSpeed Insights (Lighthouse) via Google's FREE API. Copied from SAGE.
 * A PAGESPEED_API_KEY just raises the rate limit; the data is identical. This is
 * the "SEO hook" in NOVA's prospect research + outreach (real, measured data).
 */
